...
public interface AmrIngestionRepository {
    ...
    List<Map<String, Object>> findOracleReadings(List<String> meterIds, LocalDateTime start, LocalDateTime end);
    ...
    BigDecimal getPreviousPeriodConsumption(String maKhang, String currentMonth, int currentPeriod);
    List<BigDecimal> getHistoricalConsumptions(String maKhang, String currentMonth, int currentPeriod);
