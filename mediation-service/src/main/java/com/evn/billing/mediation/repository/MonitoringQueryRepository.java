...
public interface MonitoringQueryRepository {
    ...
    List<Map<String, Object>> findCalculationLogs(String dtuongQly, String accountId, String status, int limit);
    Optional<Map<String, Object>> findCalculationLogDetail(String logId);
    List<Map<String, Object>> findErrorLogs(String accountId, String month, Integer period, int limit);
